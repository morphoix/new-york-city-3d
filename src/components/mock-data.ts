...
export const KEYFRAME_SET = [
  {
    center: {
      lng: -74.01336710705631,
      lat: 40.70566722992993,
    },
    zoom: 19.35414766495067,
    pitch: 81.49999999999983,
    bearing: 35.794442146608844,
    duration: 5000,
  },
  ...
  {
    center: {
      lng: -73.98957887459025,
      lat: 40.73417978185239,
    },
    zoom: 17.89247821083136,
    pitch: 82.49999999999996,
    bearing: 29.600000000001046,
    duration: 15000,
  },
  // {
  //   zoom: 17.89247821083136,
  //   center: {
  //     lng: -73.98883101861989,
  //     lat: 40.73721951102769,
  //   },
  //   pitch: 28.000000000000114,
  //   bearing: 18.400000000001455,
  // },
  // {
  //   zoom: 15.787853567742378,
  //   center: {
  //     lng: -73.99540988056877,
  //     lat: 40.75735520655843,
  //   },
  //   pitch: 76.2538655599201,
  //   bearing: 73.60000000000059,
  // },
];
